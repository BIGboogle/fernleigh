...
export default function Footer() {
    ...
    if (pathname === "/signup" || pathname === "/login" || pathname === "/account" || pathname === "/measurement" || pathname.endsWith("/checkout")) {
        return (
            <></>
        )
    }
    ...
    return (
        <main className="bottom-0 w-full border-t border-slate-200 pt-10 px-4">
            ...
            <div className="py-3 w-full text-center font-alt border-t border-slate-100">2026 fernleigh.
                <div className="ml-4">Designed by <a href="https://www.instagram.com/Web4Tea" className="underline">Web4Tea</a></div>
            </div>
        </main>
    )
}