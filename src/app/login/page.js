...
export default function SignupPage() {
    ...
    return (
        <main className="w-screen max-w-md my-auto mx-auto py-8 px-4">
            <h1 className="text-3xl text-center font-medium font-alt mb-4">Login in to account</h1>
            ...
            <form className="flex flex-col gap-4 font-text" onSubmit={handleSubmit}>
                ...
                />
                <div className="flex border border-black/50 rounded-full items-center pr-4">
                    <input
